...
public class Preferences{
  ...
  private static final String ROOT_FOLDER="SOFTWARE\\Alpha";
  ...
  private static native void putBytes(int root,String path,byte[] bytes)throws Exception;
