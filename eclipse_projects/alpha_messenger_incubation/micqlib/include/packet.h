/* $Id: packet.h,v 1.47 2005/02/10 21:17:18 kuhlmann Exp $ */
...
typedef enum {
  ...
  CAP_STR_2002, CAP_AIM_CHAT, CAP_TYPING,
  CAP_TRILL_CRYPT, CAP_TRILL_2, CAP_LICQ, CAP_LICQNEW, CAP_SIM, CAP_SIMNEW,
  CAP_MACICQ, CAP_MICQ, CAP_KXICQ, CAP_KOPETE,
  CAP_IMSECURE, CAP_ARQ, CAP_UTF8ii, CAP_AIM_INTER,
  CAP_WIERD1, CAP_WIERD2, CAP_WIERD3, CAP_WIERD4, CAP_WIERD5, CAP_11, CAP_12,
  CAP_MAX = 63
} cap_id_t;
