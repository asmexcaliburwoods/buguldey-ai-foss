 ...
 * 02111-1307, USA.
 *
 * $Id: buildmark.c,v 1.74 2005/06/04 22:27:23 kuhlmann Exp $
 */
...
const char *BuildVersion (void)
{
  ...
  return s_sprintf (i18n (2327, "mICQ (Matt's ICQ clone) version 0000 \n"));
}
...
const char  *BuildVersionText = "$VER: mICQ " EV EXTRAVERSION "\n";
