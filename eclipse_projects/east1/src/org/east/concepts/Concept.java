...
public class Concept implements Serializable{
  private static final long serialVersionUID = 7682708398814757062L;
  private static final Map<Long, Concept> conceptId2concept=new HashMap<Long, Concept>();
  ...
  public synchronized void addName(String name){
    ...
    Set<String> n=new HashSet<String>(list.size()+1);
    n.addAll(list);
    n.add(name);
  ...
  public static synchronized Concept resolve(long conceptId){
    ...
    Concept concept=conceptId2concept.get(conceptIdLong);
