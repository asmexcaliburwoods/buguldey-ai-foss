...
public class Sentence extends TextSection{
  private static final long serialVersionUID = 6074146201901015669L;
  ...
  public static Sentence createFromWordList(List<Word> words,TextSectionContext parentTextSectionContext,Text parentText,SentenceParsingProcessContext sentenceParsingProcessContext){
  ...
  private Sentence(String sentence,List<Word> words,TextSectionContext parentTextSectionContext,Text parentText){
    ...
    this.words=Collections.unmodifiableList(new ArrayList<Word>(words));
...
//    return sb.toString();
  ...
  private static String wordsToString(List<Word> words){
    StringBuffer sb=new StringBuffer();
