...
public class Text extends TextSection{
  private static final long serialVersionUID = -3478254055606936262L;
  private List<Sentence> sections;
  ...
  public Text(String title,String content,Text parentText){
    ...
    List<Sentence> sections=new ArrayList<Sentence>();
    ...
    Text.addSentenceIfNotNull(
            sections,
            parseSentence(textSectionContext,this,sentence));
    this.sections=Collections.unmodifiableList(new ArrayList<Sentence>(sections));
  }
  /** @return List of TextSection*/
  public List<Sentence> getSections(){
//    TextSection
    return sections;
  }
...
//  }
  private static void addSentenceIfNotNull(List<Sentence> sectionsInText, Sentence s){
