...
public class Word implements Serializable{
  ...
  public synchronized Set getWordForms() throws Exception{
    ...
    if(wordForms==null)wordForms=new HashSet();
...
//      }
  ...
  private boolean spellingMatches(String term,SentenceParsingProcessContext sentenceParsingProcessContext) throws Exception, IOException{
    ...
    List words=new ArrayList(sentence.getWords());
