...
public class DescartesParadigmGrammarTranslator {

	public static DescartesParadigm parseParadigmFile (File file) {
		System.out.println("Descartes paradigm grammar parser (Apr 25, 2012)");
//		String nsName = null, frameDir = null, ddtString = null;
...
//		}
		if (file != null) {
//			String srcDir = file.getAbsoluteFile().getParentFile().getAbsolutePath();
...
//			if (ddtString != null) parser.tab.SetDDT(ddtString);
			...
			DescartesParadigm dp=parser.Parse();
...
//				"Usage: dp File.descartesparadigm {Option}\n" +
//				"Options:\n" +
//				"  -package <packageName>\n" +
...
//				"or in a directory specified in the -frames option.\n"
			"Reason: `file' parameter must be non-null");
		}
	}
