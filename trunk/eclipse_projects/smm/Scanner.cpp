...
void Scanner::Init() {
	...
	noSym = 21;
	int i;
	for (i = 40; i <= 41; ++i) start.set(i, 1);
	for (i = 45; i <= 46; ++i) start.set(i, 1);
	for (i = 62; i <= 62; ++i) start.set(i, 1);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 1:
			...
			if ((ch >= L'(' && ch <= L')') || (ch >= L'-' && ch <= L'.') || (ch >= L'0' && ch <= L'9') || ch == L'>' || (ch >= L'A' && ch <= L'Z') || ch == L'_' || (ch >= L'a' && ch <= L'z')) {AddCh(); goto case_1;}
		...
		case 3:
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'A' && ch <= L'Z') || ch == 92 || ch == L'_' || (ch >= L'a' && ch <= L'z')) {AddCh(); goto case_4;}
			else {goto case_0;}
		case 4:
			case_4:
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'A' && ch <= L'Z') || ch == 92 || ch == L'_' || (ch >= L'a' && ch <= L'z')) {AddCh(); goto case_4;}
		...
		case 19:
			...
			else if (ch == L'c') {AddCh(); goto case_8;}
			else if (ch == L'.') {AddCh(); goto case_9;}
			else if (ch == L'{') {AddCh(); goto case_10;}
			else if (ch == L'}') {AddCh(); goto case_11;}
			else if (ch == L'v') {AddCh(); goto case_12;}
			else if (ch == L'd') {AddCh(); goto case_13;}
			else if (ch == L'f') {AddCh(); goto case_14;}
			else if (ch == L'e') {AddCh(); goto case_15;}
			else if (ch == L'a') {AddCh(); goto case_16;}
			else if (ch == L'p') {AddCh(); goto case_17;}
